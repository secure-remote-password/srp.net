...
namespace SecureRemotePassword
{
	...
	public class SrpParameters
	{
		...
		private const string SafePrime1024 = @"
			...
			FD5138FE 8376435B 9FC61D2F C0EB06E3"; // g = 2

		private const string SafePrime1536 = @"
			...
			8CE7A28C 2442C6F3 15180F93 499A234D CF76E3FE D135F9BB"; // g = 2

		// used by secure-remote-password npm package
		private const string SafePrime2048 = @"
		...
		private const string SafePrime3072 = @"
			...
			E0FD108E 4B82D120 A93AD2CA FFFFFFFF FFFFFFFF"; // g = 5

		// this prime is: 2^4096 - 2^4032 - 1 + 2^64 * { [2^3966 pi] + 240904 }
		private const string SafePrime4096 = @"
			FFFFFFFF FFFFFFFF C90FDAA2 2168C234 C4C6628B 80DC1CD1 29024E08
			8A67CC74 020BBEA6 3B139B22 514A0879 8E3404DD EF9519B3 CD3A431B
			302B0A6D F25F1437 4FE1356D 6D51C245 E485B576 625E7EC6 F44C42E9
			A637ED6B 0BFF5CB6 F406B7ED EE386BFB 5A899FA5 AE9F2411 7C4B1FE6
			...
			FFFFFFFF FFFFFFFF"; // g = 5

		// this prime is: 2^6144 - 2^6080 - 1 + 2^64 * { [2^6014 pi] + 929484 }
		private const string SafePrime6144 = @"
			FFFFFFFF FFFFFFFF C90FDAA2 2168C234 C4C6628B 80DC1CD1 29024E08
			8A67CC74 020BBEA6 3B139B22 514A0879 8E3404DD EF9519B3 CD3A431B
			302B0A6D F25F1437 4FE1356D 6D51C245 E485B576 625E7EC6 F44C42E9
			A637ED6B 0BFF5CB6 F406B7ED EE386BFB 5A899FA5 AE9F2411 7C4B1FE6
			...
			6DCC4024 FFFFFFFF FFFFFFFF"; // g = 5

		// this prime is: 2^8192 - 2^8128 - 1 + 2^64 * { [2^8062 pi] + 4743158 }
		private const string SafePrime8192 = @"
			FFFFFFFF FFFFFFFF C90FDAA2 2168C234 C4C6628B 80DC1CD1 29024E08
			8A67CC74 020BBEA6 3B139B22 514A0879 8E3404DD EF9519B3 CD3A431B
			302B0A6D F25F1437 4FE1356D 6D51C245 E485B576 625E7EC6 F44C42E9
			A637ED6B 0BFF5CB6 F406B7ED EE386BFB 5A899FA5 AE9F2411 7C4B1FE6
			...
			60C980DD 98EDD3DF FFFFFFFF FFFFFFFF"; // g = 19 decimal
